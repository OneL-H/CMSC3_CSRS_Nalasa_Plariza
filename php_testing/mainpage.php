    ...
    <nav class="navbar navbar-expand-sm body bg-primary m-3 rounded rounded-2 fixed-top" style="width: 97%">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse justify-content-end" id="">
                <form method="POST" action="mainpage.php" class="row m-2">
                    <div class="col-auto invisible">
                        <span class="form-control-plaintext">Invalid Student Number or Password</span>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="password" class="form-control form-control-sm" id="studentPassword"
        ...
        <div class="row">
            ...
            <div class="announcements col-8">
                ...
                <div>
                    ...
                    <p>You may directly go to <a href="https://bit.ly/RequestForStudentRecords2022">this link</a> for
                        your
                        requests on the following:</p>
                    <ol type="1">
                        <li>Request for True copy of grades and Certificate of No Contract; and </li>
                        <li>Certificate of Good Moral: <a
                                href="mailto: osa.upmindanao@up.edu.ph">osa.upmindanao@up.edu.ph</a>
                        </li>
                    </ol>
                </div>
                ...
                <div>
                    <h1>ATTENTION: ALL STUDENTS</h1>
                    <p>PLEASED BE INFORMED THAT THE FOLLOWING SECIONS IN PE 1 HAS BEEN DISSOLVED: PE 1 (F), PE 1 (G), PE
                        1 (GH)
                        and PE 1 (WX)</p>
                </div>
                ...
                <div>
                    <h1>ALL STUDENTS with INC’s and 4.0’s INCURRED during SECOND SEM. 2018-2019 and 1st sem 2019-2020
                    </h1>
                    <p>Please be informed that you have to complete/remove your Academic Deficiencies <strong>before the
                            first
                            day of the regular registration period for the SECOND semester, AY 2020-2021 (24 February
                            2021) or
                ...
                <div>
                    ...
                    <p>The 6 units of Free Electives in the BS Bio Curriculum can be selected from any 3-unit
                        non-Biology
                        courses that are offered in the University. A student is 'free' to choose from the offerings
                        across
                        colleges, provided that if a course has a prerequisite, such must have been satisfied first
                        before
                ...
                <div>
                    ...
                    <p>For DMPCS registration / enrollment concerns please join our <a
                            ...
                            workspace</a>.
                        <br><br>For Physics 3 prerog concerns, once you have joined our worskspace please join the
                        channel
                ...
                <div>
                    ...
                    <p>You are to take FST 164 (pre-req FST 140 and FST 141) instead of FST 151 this 1st sem 2020-2021.
                    </p>
                </div>
            ...
            <div class="sidebar col-4 ">
                ...
                <h1 id="personalannouncements">PERSONAL ANNOUNCEMENTS</h1>

                <div class="afterh1">
                    <h1>Announcement 1</h1>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos laborum placeat esse
                        inventore
                        corporis vel a quisquam? Incidunt aliquam laborum asperiores quis cupiditate pariatur
                        consequuntur minus
                ...
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, perferendis iste ex itaque non
                        quo minus
                        eius aliquid quibusdam sint similique aperiam corrupti tempore est provident dolore enim
                        excepturi
                        sapiente.
                        <br><br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet nostrum inventore quis
                        numquam
                        exercitationem est necessitatibus voluptate quam. Nesciunt aliquid ducimus dolore placeat
                        similique,
                        quod possimus nostrum sint repudiandae earum.
                        <br><br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, minus corporis
                        rerum
